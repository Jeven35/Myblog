...
import com.jeven.myblog.component.PhoneRandomBuilder;
import com.jeven.myblog.redis.StringRedisServiceImpl;
...
//        在redis中保存手机号验证码并设置过期时间
    ...
    public static SendSmsResponse sendSmsResponse(String phoneNumber, String code, String msgCode) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIT9uPRUVswRb0", "Li3tbj1my5zqmXAMaCAAzkqfqeCL1o");
