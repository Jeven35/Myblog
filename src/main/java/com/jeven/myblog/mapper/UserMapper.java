...
import com.jeven.myblog.model.Role;
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column = "phone", property = "roles", javaType = List.class, many = @Many(select = "com.jeven.myblog.mapper.UserMapper.getRoleNameByPhone")),
    })
