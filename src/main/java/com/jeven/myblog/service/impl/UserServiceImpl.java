...
import com.jeven.myblog.constant.RoleConstant;
import com.jeven.myblog.mapper.UserMapper;
import com.jeven.myblog.model.User;
...
//        密码修改成功后注销当前用户
    ...
    public JSONObject getHeadPortraitUrl(int id) {
        ...
        String avatarImgUrl = userMapper.getHeadPortraitUrl(id)+"?x-oss-process=style/rule1";
